...
# gqa,realworldqa,ai2d,scienceqa_img,mme,mmmu_val,textvqa_val_lite,chartqa_lite
...
accelerate launch --num_processes=4 --main_process_port=11131 \
    ...
    --tasks gqa,realworldqa,ai2d,scienceqa_img,mme,mmmu_val,textvqa_val_lite,chartqa_lite \
    --batch_size 1 \
    --gen_kwargs alg=topk_margin,prefix_lm=True,max_new_tokens=16 \
    --log_samples \
