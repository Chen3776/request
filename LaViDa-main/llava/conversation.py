...
local_llada_tokenizer = "/mnt/public/chenpengyi/models/LLaDA-8B-Instruct"
...
conv_llava_llada = Conversation(
    ...
    tokenizer=safe_load_tokenizer(local_llada_tokenizer), # modified by pyc
...
local_dream_path = "/mnt/public/chenpengyi/models/Dream-v0-Instruct-7B"
...
conv_dream = Conversation(
    ...
    sep="<|im_end|>",
    sep_style=SeparatorStyle.LLAMA_3,
    tokenizer_id=local_dream_path,
    tokenizer=AutoTokenizer.from_pretrained(local_dream_path,trust_remote_code=True),
